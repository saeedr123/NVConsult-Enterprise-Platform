 ...
 * Description: Durable content models, relationships, jobs, applications, capabilities and shared platform services for NVConsult.
 * Version: 0.8.0
...
define('NVCONSULT_CORE_VERSION', '0.8.0');
