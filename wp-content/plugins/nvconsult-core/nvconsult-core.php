 ...
 * Description: Durable content models, relationships, jobs, secure applications/documents, audited applicant and staff workflows, capabilities and shared platform services for NVConsult.
 * Version: 0.15.0
...
define('NVCONSULT_CORE_VERSION', '0.15.0');
...
require_once NVCONSULT_CORE_DIR . 'includes/class-staff-workflow.php';
...
add_action('plugins_loaded', static function () {
    ...
    NVConsult_Core_Staff_Workflow::init();
});
