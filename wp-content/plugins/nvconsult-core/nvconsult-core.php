 ...
 * Description: Durable content models, relationships, jobs, applications/documents, capabilities and shared platform services for NVConsult.
 * Version: 0.9.0
...
define('NVCONSULT_CORE_VERSION', '0.9.0');
