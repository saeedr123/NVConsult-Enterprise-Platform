 ...
 * Description: Durable content models, relationships, jobs, secure applications/documents, applicant and staff workflows, capabilities and shared platform services for NVConsult.
 * Version: 0.14.0
...
define('NVCONSULT_CORE_VERSION', '0.14.0');
