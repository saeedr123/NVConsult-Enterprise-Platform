 ...
 * Description: Durable content models, relationships, editorial fields, job ingestion/search, capabilities and shared platform services for NVConsult.
 * Version: 0.7.0
...
define('NVCONSULT_CORE_VERSION', '0.7.0');
