 ...
 * Description: Durable content models, relationships, editorial fields, capabilities and shared platform services for NVConsult.
 * Version: 0.4.0
...
define('NVCONSULT_CORE_VERSION', '0.4.0');
