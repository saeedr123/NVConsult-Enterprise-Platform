<?php
/**
 * Theme functions for NVConsult Theme V2.
 *
...
function nvconsultv2_theme_enqueue_assets() {
	wp_enqueue_style( 'nvconsult-theme-v2-style', get_stylesheet_uri(), array(), '1.0.0' );
}
add_action( 'wp_enqueue_scripts', 'nvconsultv2_theme_enqueue_assets' );

function nvconsultv2_get_homepage_settings() {
	$settings = get_option( 'nvconsultv2_homepage_settings', array() );
...
function nvconsultv2_get_homepage_value( $key, $default = '' ) {
